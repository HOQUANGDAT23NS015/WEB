...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['product_id'])) {
    ...
    $quantity = isset($_POST['numsoluong']) ? intval($_POST['numsoluong']) : 1;
...
<head>
    ...
    <style>
        ...
        .back-button {
            display: inline-block;
            background-color: #ccc; /* Màu xám cho nút quay lại */
            color: black;
            padding: 10px 15px;
            border-radius: 5px;
        ...
        .back-button:hover {
            background-color: #bbb; /* Màu xám đậm khi hover */
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <a href="thanhtoan.php" class="pay-button">Thanh toán</a>
        </form>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="" class="product-form">
                            ...
                            <input type="number" name="numsoluong" class="form-control" style="width: 60px;" min="1" value="1">
        ...
        <!-- Nút Quay lại -->
        <a href="index.php" class="back-button">Quay lại trang chính</a>
    </div>
</body>
</html>
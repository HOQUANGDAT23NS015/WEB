	...
	<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/n1.png" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/n2.png" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/n3.png" alt="Dummy Image" /></li>
				</ul>

				<!-- Slide Description Image Area (316 x 328) -->
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script"><img class="img-responsive" src="images/n.png" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="images/n4.png" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="images/nen1.png" alt="Dummy Image" /></div></li>
					</ul>
